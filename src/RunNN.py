...
def predict(model, dl):
    """
    Tests model on datasets and prints some stats to a file
    :param model: model to assess
    :param dl: DataLoader to evaluate model on
    :return: None
    """
    # prediction mode
    tp = 0
...
def main(**params):
    """
    :param params: keywords, see get_args() above
    :return: model
    """
    # Try CUDA
    ...
    if not params["predictor"]:
        ...
        model.run_training(train_dl, val_set, params["epoch"], 0.003, save_every=5)
